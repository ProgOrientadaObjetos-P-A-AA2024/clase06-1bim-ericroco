...
public class ManejoArrayList5 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < profesores2.size(); i++) {
            System.out.printf("%s\n", profesores2.get(i));
            // asignamos el valor de profesores2.get(i) al objeto que creamos
            // recientemente llamado p1, esto lo hacemos para agilitar procesos
            // y dar un codigo mas legible
        }
    }
}
